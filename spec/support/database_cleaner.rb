RSpec.configure do |config|
  ...
  # that is, any test where the entire test runs in the RSpec process
  # they are preferable.
  ...
  # By default, these are the only tests for which Capybara fires up
  # a test server process and drives an actual browser window via
